# Fully updated modern LangChain imports
# Universal classic compatibility imports
from langchain_openai import ChatOpenAI, OpenAIEmbeddings, OpenAI
from langchain_core.messages import SystemMessage, HumanMessage, AIMessage
from langchain_core.prompts import PromptTemplate, SystemMessagePromptTemplate, HumanMessagePromptTemplate, ChatPromptTemplate, AIMessagePromptTemplate
...
def is_unable_to_answer(response_text):
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"Analyze if this text indicates an inability to answer the question. Return 'Yes' or 'No'.\n\nText: {response_text}"}
        ],
        temperature=0.0
    )
